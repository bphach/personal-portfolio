...
export default function Intro() {
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
        ...
        >
        Hello,{" "}<span className="font-bold text-yellow-500"> I'm Bryan.</span> I'm a{" "}
        ...
        gap-2 px-4 text-lg font-medium"
            ...
            >
                <Link href="#contact" className="bg-gray-900 text-white 
                px-7 py-3 flex items gap-2 
                ...
                <a className="group bg-white text-black 
                px-7 py-3 flex items gap-2 
                rounded-full items-center justify-center outline-none
                ...
                hover:scale-110 active:scale-105 hover:text-gray-950
                transition cursor-pointer border border-black/10"
                href="https://www.linkedin.com/in/bryan-h182/" target="_blank">
                    <BsLinkedin />
                </a>
                ...
                hover:scale-110 active:scale-105 hover:text-gray-950
                transition cursor-pointer border border-black/10"
                href="https://github.com/bphach" target="_blank" >
                    <FaGithubSquare />
            </a>
        </motion.div>
    </section>
